...
/**
 * Boîte de dialogue pour la recherche et filtrage d'instance de modèle {@link ece.ing3.java.projet.modele.hopital.Malade} de la base de donnée, avec la saisie des attributs à filtrer.
 * <p>
...
public class MaladeSearchDialog extends ModelSearchDialog {
	/**
	 * Construit la liste des champs de saisie pour le filtrage associé à {@link ece.ing3.java.projet.modele.hopital.Malade}
	 *
