...
/**
 * Champ de saisie pour sélectionner des instances de modèle {@link ece.ing3.java.projet.modele.employe.Docteur}, stockés en base de donnée, avec possibilité de sélection multiple pour la recherche, en tant que clé primaire
 */
public class DocteurIdInput extends DocteurInput {
	/**
	 * Créer un nouveau champ de saisie pour sélectionner des instances de modèle {@link ece.ing3.java.projet.modele.employe.Docteur}, en tant que clé primaire.
	 *
