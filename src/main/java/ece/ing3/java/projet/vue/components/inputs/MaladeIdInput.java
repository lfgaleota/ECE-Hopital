...
/**
 * Champ de saisie pour sélectionner des instances de modèle {@link ece.ing3.java.projet.modele.hopital.Malade}, stockés en base de donnée, avec possibilité de sélection multiple pour la recherche, en tant que clé primaire
 *
 * @author Virgile
 * @author Nicolas
 * @author Louis-Félix
...
public class MaladeIdInput extends MaladeInput {
	/**
	 * Créer un nouveau champ de saisie pour sélectionner des instances de modèle {@link ece.ing3.java.projet.modele.hopital.Malade}, en tant que clé primaire.
	 *
